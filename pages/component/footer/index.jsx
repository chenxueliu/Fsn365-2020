    ...
    <footer className="box-footer">
      <div className="footer">
        <div className="box-content">
          <p className="font-word">
            Powered by
            <a href="https://www.fusion.org/" target="_blank">
              <strong>Fusion Network</strong>
            </a>
            and
            <a href="https://fsn.dev/" target="_blank">
              <strong>FOSC</strong>
            </a>
            .
          </p>
        ...
        <div className="box-content">
          ...
          <small className="about">
            ...
            by
            <a href="https://t.me/yocnkc" target="_blank" className="jss2031">
              <strong>Kate</strong>.
            </a>
          </small>
          <small>
            <strong>Donation:</strong>
            <a href="/address/10139396/">10139396</a>
          </small>
        </div>
      </div>
    </footer>
